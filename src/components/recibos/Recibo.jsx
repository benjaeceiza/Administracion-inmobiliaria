...
const Recibo = ({ recibos, setRecargar, limite }) => {
    ...
    const dataPdf = (nombre, concepto, descripcion, monto, fecha, numero, tipo, idprop) => {
        ...
        docc.addImage("https://i.postimg.cc/T3f2LrdP/icons8-casa-96.png", "JPG", 10, 10, 20,20);
        docc.setFontSize(20)
        docc.setFont("italic")
        ...
        docc.addImage("https://i.postimg.cc/jjqj9ym1/E-COMERCE-2.png", "JPG", 20, 150, 180, 100);
        docc.setFontSize(15)
        docc.getFontList("italic")
